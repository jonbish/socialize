...
class SocializeAdmin {
	...
	function socialize_services_admin(){
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-pinterest', 'Pinterest Button Settings', $pinterest_buttons_content);
	...
	function sort_buttons_array($socializemeta){
		...
		$inline_buttons_array = $socializeWPservices->get_button_array('inline');
		$alert_buttons_array = $socializeWPservices->get_button_array('action');
